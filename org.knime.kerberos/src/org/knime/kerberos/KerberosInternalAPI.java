 ...
 *
 * History
 *   29.01.2019 (Mareike Hoeger, KNIME GmbH, Konstanz, Germany): created
 */
 ...
 */
public class KerberosInternalAPI {

    private KerberosInternalAPI() {
        //Utility class
    }

    /**
     * Validates the saved configuration. This can only be done if the user is currently not logged in.
     *
     * @param config the KerberosPluginConfig to validate
     * @param logoutIfNecessary whether to logout if still logged in
     *
     *
    ...
    /**
     * Login with current saved configuration.
     *
     * @param config the KerberosPluginConfig to use for authentication
